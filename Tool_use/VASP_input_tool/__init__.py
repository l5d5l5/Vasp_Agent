...
Package layout / 包结构:
  flow/                     Core VASP I/O layer  /  核心 VASP 输入输出层
    ...
    maker.py                VaspInputMaker: legacy direct-use factory (not called by WorkflowEngine)
    input_sets/             pymatgen InputSet subclasses (package: bulk_slab, static, spectroscopy, transition, md)
